...
A frame is a bounded informational context with an internal state, accessible relations, and consistency constraints. Observation is directed information transfer between frames. A measurement-like event is a special case in which a receiving frame becomes stably bound to outcome-relative information.

On this view:

- Collapse is interpreted as frame-relative state update, not necessarily as universal physical discontinuity.
...
1. [Frames Theory: A Relational Information Framework for Physical Reality](01-Frames-Theory.md)
2. [The Born Rule as a Frame-Binding Measure in Frames Theory](02-Born-Rule-Frame-Binding.md)
3. [Frame-Relative State Update: Projection, Partial Trace, and Decoherence in Frames Theory](03-Frame-Relative-State-Update.md)
4. [Toward a Frames-Theoretic Derivation of the Born Rule](04-Born-Rule-Derivation.md)
5. [Classical Objectivity as Redundant Frame-Binding in Frames Theory](05-Classical-Objectivity-Redundant-Frame-Binding.md)
6. [Entanglement, Nonlocality, and No-Signaling in Frames Theory](06-Entanglement-Nonlocality-No-Signaling.md)
7. [Relativistic Frames and Causal Information Boundaries in Frames Theory](07-Relativistic-Frames-Causal-Information-Boundaries.md)
8. [Cosmological Frames and Horizon-Bounded Reality in Frames Theory](08-Cosmological-Frames-Horizon-Bounded-Reality.md)
9. [Time, Memory, and Records in Frames Theory](09-Time-Memory-Records.md)
